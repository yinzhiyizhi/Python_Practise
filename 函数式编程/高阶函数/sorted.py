...
print(sorted([36,2,43,-234,-34,24]))
# [-234, -34, 2, 24, 36, 43]

# 此外，sorted()函数也是一个高阶函数，
# 它还可以接收一个key函数来实现自定义的排序，
# 例如按绝对值大小排序：
print(sorted([36,2,43,-234,-34,24],key=abs))
# [2, 24, -34, 36, 43, -234]

# key指定的函数将作用于list的每一个元素上，
# 并根据key函数返回的结果进行排序。
# 对比原始的list和经过key=abs处理过的list：
# list=[36,2,43,-234,-34,24]
# keys=[2, 24, -34, 36, 43, -234]

# 然后sorted()函数按照keys进行排序，并按照对应关系返回list相应的元素：

# keys排序结果 => [2, 24,  34, 36, 43,  234]
#                 |   |    |   |   |    |
# 最终结果     => [2, 24, -34, 36, 43, -234]
