...
# 'E:\Study\Practice\Python\IO编程'

# 在某个目录下创建一个新目录，首先把新目录的完整路径表示出来:
os.path.join('C:/Users/Administrator/Desktop','testdir')
# 'C:/Users/Administrator/Desktop/testdir'
...
findfile('C:\\Users\\Administrator\\Desktop','test')
