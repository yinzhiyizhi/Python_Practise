...
def tcplink(sock,addr):
    ...
    while True:
        ...
        if not data or data.decode('utf-8') == 'exit':
            break
        sock.send(('Hello,%s!' % data.decode('utf-8')).encode('uft-8'))
    sock.close()
...
# 我们需要打开两个命令行窗口，一个运行服务器程序，
# 另一个运行客户端程序，就可以看到效果了：

# https://cdn.liaoxuefeng.com/cdn/files/attachments/001410425071613d61a12d8f77b4cf8ad20c0b3233782b9000
