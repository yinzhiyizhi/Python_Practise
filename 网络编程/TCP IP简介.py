...
# 计算机为了联网，就必须规定通信协议，
# 早期的计算机网络，都是由各厂商自己规定一套协议，
# IBM、Apple和Microsoft都有各自的网络协议，互不兼容，
# 这就好比一群人有的说英语，有的说中文，有的说德语，
# 说同一种语言的人可以交流，不同的语言之间就不行了。

# 为了把全世界的所有不同类型的计算机都连接起来，
# 就必须规定一套全球通用的协议，为了实现互联网这个目标，
# 互联网协议簇（Internet Protocol Suite）就是通用协议标准。
# Internet是由inter和net两个单词组合起来的，
# 原意就是连接“网络”的网络，有了Internet，
...
# https://cdn.liaoxuefeng.com/cdn/files/attachments/001410416110024ba5ff10ba0034fa8bfb1d5f7379bfaa6000

# IP地址实际上是一个32位整数（称为IPv4），
# 以字符串表示的IP地址如192.168.0.1实际上是把32位整数按8位分组后的数字表示，
# 目的是便于阅读。
